...
##
## Description: All I did to change the simulator was add the I_IADDQ
## pipeline parameters (i.e use r_A vs. r_B, etc), just as we did in
## part B. I actually just used that as reference to double check that
## my simulator was looking good! Not a whole lot of depth in the edits
## made here. NCopy.ys is where the action happens.
##
